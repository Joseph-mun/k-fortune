...
function getStyleClasses(style: string) {
  const styles: Record<string, {
    ...
    classic: {
      container: "border border-[#E8DFD3] shadow-xl shadow-[rgba(197,55,46,0.05)]",
      background: "bg-gradient-to-b from-[#F5F0E8] to-[#EDE7DB]",
      title: "text-[#1A1611]",
      text: "text-[#6B6358]",
      muted: "text-[#9B9287]",
      iconBg: "bg-[#C5372E]/[0.1] border border-[#C5372E]/[0.2]",
      pillarBg: "bg-[#1A1611]/[0.03]",
    },
    tarot: {
      container: "border border-gold-500/[0.2] shadow-xl shadow-gold-500/[0.05]",
      background: "bg-gradient-to-b from-[#F8F3EB] to-[#F0E8D8]",
      title: "text-gold-700",
      text: "text-gold-800/[0.6]",
      muted: "text-gold-600/[0.5]",
    ...
    neon: {
      ...
      background: "bg-gradient-to-b from-[#F0EDFF] to-[#E8E4FF]",
      title: "text-purple-700",
      text: "text-purple-600/[0.7]",
      muted: "text-purple-500/[0.6]",
    ...
    seasonal: {
      ...
      background: "bg-gradient-to-b from-[#FFF1F2] to-[#FFE4E6]",
      title: "text-pink-700",
      text: "text-pink-600/[0.7]",
      muted: "text-pink-500/[0.5]",
